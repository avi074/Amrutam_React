    ...
    <>
      <header className='p-4 px-12 grid grid-flow-col-dense bg-primary-foreground'>
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `bg-transparent text-xl mx-4 p-1 rounded-md border border-transparent ${
                        isActive ? "text-primary font-bold hover:underline hover:border-primary" : "text-neutral-800 font-medium hover:bg-primary hover:text-neutral-50"
                      }`
                    }>
                    {link.name}
                  </NavLink>
        ...
        <div className="flex justify-end px-4 items-center gap-2">
          <Button variant='outline' className="text-primary bg-transparent text-[1rem] border border-primary shadow-md tracking-wide hover:bg-primary hover:text-white">Login</Button>
